...
cn_model = KeyedVectors.load_word2vec_format(r'D:\graduate\Chinese-Word-Vectors-master\sgns.zhihu.bigram-char', 
                                          binary=False)

train_texts_orig= []
with open(r'D:\graduate\project\sklearn\train_text.txt','r',encoding='utf-8')as f:
    text=f.readlines()
    for j in text:
        j=j.split('\n')
